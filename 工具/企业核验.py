...
背景：2026-07 「茹美达」真实踩坑案例——运营助理岗位，做了两天后发现实际发薪方
（武汉新鑫明宇环保科技有限公司）与招聘展示主体不一致，且任务内容（整理京东商品
链接）与该发薪主体的主营业务（环保科技）明显不符，联网核验后判断为高危/灰产。
本脚本据此把这类信号固化为可复用的核查维度，而不只是查"公司是否存在"。

用法：
    python 工具/企业核验.py --公司 "茹美达|实习僧|运营助理|发薪方为武汉新鑫明宇环保科技有限公司，与招聘主体不一致；任务为整理京东商品链接"
